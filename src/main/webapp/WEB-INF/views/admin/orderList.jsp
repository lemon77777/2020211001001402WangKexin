			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.WangKexin.model.Order o=(com.WangKexin.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.WangKexin.dao.UserDao userDao=new com.WangKexin.dao.UserDao();
						...
						<%
							...
							String paymentType=com.WangKexin.model.Payment.findByPaymentId(con,n);
							 %>
