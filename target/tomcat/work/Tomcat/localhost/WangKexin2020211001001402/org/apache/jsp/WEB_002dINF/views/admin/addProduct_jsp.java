 ...
 * Generated at: 2022-05-08 06:05:21 UTC
...
public final class addProduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/admin/../header.jsp", Long.valueOf(1651394840806L));
  }
...
if(session.getAttribute("user")!=null){
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<option value=\"1\">FASHION</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <option value=\"2\">HOUSEHOLDS</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <option value=\"3\">INTERIORS</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <option value=\"4\">CLOTHING</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <option value=\"5\">BAGS</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <option value=\"6\">SHOES</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <option value=\"7\">BOOKS</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t    <option value=\"8\">OTHER</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<!-- loop_end -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t            </div>\r\n");
